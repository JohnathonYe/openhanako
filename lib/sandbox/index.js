...
import { wrapPathTool, wrapBashTool, wrapWriteWithDiff, wrapEditWithBackup } from "./tool-wrapper.js";
  ...
  if (policy.mode === "full-access") {
    ...
    return {
      tools: [
        ...
        wrapWriteWithDiff(createWriteTool(cwd), cwd),
        wrapEditWithBackup(createEditTool(cwd), cwd),
        bashTool,
        createGrepTool(cwd),
        createFindTool(cwd),
        createLsTool(cwd),
  ...
  if (platform === "win32-full-access") {
    ...
    return {
      tools: [
        ...
        wrapWriteWithDiff(wrapPathTool(createWriteTool(cwd), guard, "write", cwd), cwd),
        wrapEditWithBackup(wrapPathTool(createEditTool(cwd), guard, "write", cwd), cwd),
